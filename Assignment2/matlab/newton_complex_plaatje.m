function x = newton_complex_plaatje(vector_complex_numbers,vector_discretization,iteration_steps)
%uitleg
%%voorbeeld voor input: newton_complex_plaatje([-8-8i;8+8i],[100;100],21)
...
image([real_low complex_high],[complex_low complex_high],m),  % This plots the results.
